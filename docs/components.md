...
| `SolveSurface` | `src/components/SolveSurface.tsx` | Unified solve layout that aligns the grid and clue list on a shared surface with responsive CSS grid sizing. |
